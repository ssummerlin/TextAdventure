...
bloo,public static void main(String[]args){

		}
* Doors can be open or locked. That state should be maintained in this class.\
		Chris
 * A door's level cannot be chters)
 *  * 2. a level and an open/locked state
 *  *
 *  * The danged once the class has been created. You should create multiple constructors that allow
 * the Door to be created:
 * 1. without any inputs (i.e. default parameefault values for a door are level = 1 and isOpen = false
 */
